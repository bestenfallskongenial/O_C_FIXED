...
void            CKernel::wrapper_load_sd            (   )
{
                if(Mount( PARTITION_NAME_SD ))
                    ...
                    scanRoot                (   g_ScnTex, g_SufTex, filecounter[FT_TEX][FLD_EXTCNT], filecounter[FT_TEX][FLD_SCANNED], filecounter[FT_TEX][FLD_MAXSD], filecounter[FT_TEX][FLD_LOADED]);
                    scanRoot                (   g_ScnVid, g_SufVid, filecounter[FT_VID][FLD_EXTCNT], filecounter[FT_VID][FLD_SCANNED], filecounter[FT_VID][FLD_MAXSD], filecounter[FT_VID][FLD_LOADED]);
                    ...
                    bulkLoad                (   g_ScnTex, g_bytTex, m_bufferTex, filecounter[FT_TEX][FLD_SCANNED], filecounter[FT_TEX][FLD_LOADED], filecounter[FT_TEX][FLD_PREV], filecounter[FT_TEX][FLD_SIZE]);
                    bulkLoad                (   g_ScnVid, g_bytVid, m_bufferVid, filecounter[FT_VID][FLD_SCANNED], filecounter[FT_VID][FLD_LOADED], filecounter[FT_VID][FLD_PREV], filecounter[FT_VID][FLD_SIZE]);
                    bulkLoad                (   g_ScnKln, g_bytKln, m_bufferKnl, filecounter[FT_KLN][FLD_SCANNED], filecounter[FT_KLN][FLD_LOADED], filecounter[FT_KLN][FLD_PREV], filecounter[FT_KLN][FLD_SIZE]);
                    UnMount();
                    }
...
void            CKernel::wrapper_load_usb           (   )
{
                if(Mount( PARTITION_NAME_USB ))
                    {
                    scanRoot                (   g_ScnFsh, g_SufFsh, filecounter[FT_FSH][FLD_EXTCNT], filecounter[FT_FSH][FLD_SCANNED], filecounter[FT_FSH][FLD_MAXUSB], filecounter[FT_FSH][FLD_LOADED]);  
                    scanRoot                (   g_ScnTex, g_SufTex, filecounter[FT_TEX][FLD_EXTCNT], filecounter[FT_TEX][FLD_SCANNED], filecounter[FT_TEX][FLD_MAXUSB], filecounter[FT_TEX][FLD_LOADED]);
                    scanRoot                (   g_ScnVid, g_SufVid, filecounter[FT_VID][FLD_EXTCNT], filecounter[FT_VID][FLD_SCANNED], filecounter[FT_VID][FLD_MAXUSB], filecounter[FT_VID][FLD_LOADED]);
                    scanRoot                (   g_ScnKln, g_SufKln, filecounter[FT_KLN][FLD_EXTCNT], filecounter[FT_KLN][FLD_SCANNED], filecounter[FT_KLN][FLD_MAXUSB], filecounter[FT_KLN][FLD_LOADED]);
...
{
                BMPparser       (   &m_omt, m_bufferOmt, g_ScnOmt, g_bytOmt, filecounter[FT_OMT][FLD_SIZE], filecounter[FT_OMT][FLD_PREV], filecounter[FT_OMT][FLD_LOADED]);
                BMPparser       (   &m_tex, m_bufferTex, g_ScnTex, g_bytTex, filecounter[FT_TEX][FLD_SIZE], filecounter[FT_TEX][FLD_PREV], filecounter[FT_TEX][FLD_LOADED]); 
}

void            CKernel::wrapper_parser_usb()
{
                BMPparser       (   &m_tex, m_bufferTex, g_ScnTex, g_bytTex, filecounter[FT_TEX][FLD_SIZE], filecounter[FT_TEX][FLD_PREV], filecounter[FT_TEX][FLD_LOADED]);      
                parse264        (   &m_vid, m_videoBlockBase, m_bufferVid, g_ScnVid, g_bytVid, filecounter[FT_VID][FLD_PREV], filecounter[FT_VID][FLD_LOADED], filecounter[FT_VID][FLD_VALID], MIN_VID_W, MAX_VID_W, MIN_VID_H, MAX_VID_H, MIN_VID_P, MAX_VID_P, MIN_VID_L, MAX_VID_L);        
}
