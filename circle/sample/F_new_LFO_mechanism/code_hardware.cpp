...
u32             CKernel::getClockMilliseconds      (   void )
{
                PeripheralEntry();

                u32 value = read32(ARM_SYSTIMER_CLO);
...
{
                const int f_scale = m_scaleFactors[g_centralModeBuffer[g_gl_program_current][ATTENUATION]];
