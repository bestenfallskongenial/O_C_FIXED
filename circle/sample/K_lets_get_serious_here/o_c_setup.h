...
// media
    #define         SLOTS                   ( FSH_SD + FSH_USB + 1 )            // for the g_centralModeBuffer[SLOTS][MODETABLE_COUNT] array - 1 firmware / 32 user / 1 default slot
    #define         DEFAULT_SLOT            ( FSH_SD + FSH_USB )                //  because 0 plus 34 = 33 ?? 

    #define         MAX_OMF                 ( OMF_SD + OMF_USB )    // 1
